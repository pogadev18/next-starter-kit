        ...
        <div className="flex flex-col md:flex-row gap-y-14 w-full justify-between">
          <div className="">
            ...
            <p className="mt-5 text-gray-500 text-lg max-w-[600px]">
              Our online service makes it easy to connect with others who share your interests, whether it's hiking,
              painting, or playing soccer. Create or join a group, schedule meetups, and enjoy pursuing your passions
              with new friends by your side. Start building your community today!
            </p>
