...
export default async function Settings({ params }: { params: { groupId: string } }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <ConfigurationPanel title={'Group Image'}>
          <div className="flex flex-col gap-8">
            ...
            />
            <p className="dark:text-gray-400 text-sm">Upload a group image to make your group stand out.</p>
        ...
        <ConfigurationPanel title={'Group Visibility'}>
          <div className="flex flex-col gap-8">
            <p className="dark:text-gray-400 text-sm">
              Groups are private by default. If you want random people on the internet to find and join your group
              without an invite, switch this to on.
            </p>
