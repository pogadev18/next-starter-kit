          ...
          <div className="space-y-24">
            <div className="space-y-8">
              ...
              {upcomingEvents.length === 0 && (
                <p className={cn(cardStyles, 'flex gap-8 items-center mt-8 py-4 px-4')}>No upcoming events found</p>
              )}
            ...
            <div className="space-y-8">
              ...
              {pastEvents.length === 0 && (
                <p className={cn(cardStyles, 'flex gap-8 items-center mt-8 py-4 px-4')}>No expired events found</p>
              )}
