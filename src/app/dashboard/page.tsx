...
export default async function DashboardPage() {
  ...
  if (!hasGroups) {
    return (
      <div className={cn('space-y-8 container mx-auto py-24 min-h-screen max-w-2xl flex flex-col items-center')}>
    ...
    <>
      ...
      <div className={cn('space-y-8 container mx-auto py-12 min-h-screen')}>
        ...
        {memberGroups.length === 0 && (
          <p className={cn(cardStyles, 'flex gap-8 items-center mt-8 py-4 px-4')}>You're not part of any groups</p>
        )}
