...
export function ConditionalHeader({ session }: { isPremium: boolean; session: Session | null }) {
      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex gap-8 items-center">
          <Link href="/" className="flex gap-2 items-center text-xl">
            <Image className="rounded w-8 h-8" width="50" height="50" src="/group.jpeg" alt="hero image" />
            {applicationName}
          </Link>
            ...
            <>
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem>
                    <Link href="/api/auth/signout?callbackUrl=/" className="flex gap-2 items-center">
