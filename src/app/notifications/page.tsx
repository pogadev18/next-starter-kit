    ...
    <>
      <PageHeader>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
          <h1 className={cn(pageTitleStyles, 'flex justify-between items-center')}>Your Notifications</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-8">
            {notifications.map((notification) => {
              return (
                <div key={notification.id} className="p-4 sm:p-6 md:p-8 border rounded-xl space-y-4 w-full">
