...
export async function createNotification(notification: {
  ...
  const [createdNotification] = await database.insert(notifications).values(notification).returning()
...
export async function updateNotification(notificationId: number, updatedNotification: Partial<Notification>) {
