            ...
            <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
              ...
              <Section className="text-center mt-[32px] mb-[32px]">
                <Text className="text-black font-medium text-[14px] leading-[24px] mb-8">
                  You&apos; been invited to a group on groupfinder.com called {group.name}. Click the link below to
                  login and access your group.
                </Text>

                <Text className="text-black font-medium text-[14px] leading-[24px]">
                  <Link href={`${BASE_URL}/invites/${token}`} target="_blank" className="text-[#2754C5] underline">
                    Login to View Group
                  </Link>
                </Text>
              </Section>
