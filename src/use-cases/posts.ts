...
export async function getPostsInGroupUseCase(authenticatedUser: UserSession | undefined, groupId: GroupId) {
...
export async function getPostByIdUseCase(authenticatedUser: UserSession | undefined, postId: number) {
...
export async function canEditPostUseCase(authenticatedUser: UserSession | undefined, postId: number) {
  ...
  return (await isAdminOrOwnerOfGroup(authenticatedUser, post.groupId)) || post.userId === authenticatedUser.id
}
