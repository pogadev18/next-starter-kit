...
export async function getGroupsByUserUseCase(authenticatedUser: UserSession) {
  return [...(await getGroupsByUser(authenticatedUser.id)), ...(await getGroupsByMembership(authenticatedUser.id))]
}
...
export async function toggleGroupVisibilityUseCase(authenticatedUser: UserSession, groupId: GroupId) {
...
export async function getMemberCountUseCase(authenticatedUser: UserSession | undefined, groupId: GroupId) {
...
export async function deleteGroupUseCase(authenticatedUser: UserSession, { groupId }: { groupId: GroupId }) {
  await assertGroupOwner(authenticatedUser, groupId)
  await deleteGroup(groupId)
}

export async function isAdminOrOwnerOfGroupUseCase(authenticatedUser: UserSession | undefined, groupId: GroupId) {
