...
export async function getReplyCountUseCase(authenticatedUser: UserSession | undefined, postId: number) {
  const replyCount = await getReplyCountOnPost(postId)
  return replyCount
}

export async function getRepliesForPostUseCase(authenticatedUser: UserSession | undefined, postId: number) {
...
export async function createReplyUseCase(authenticatedUser: UserSession, reply: { postId: number; message: string }) {
...
export async function deleteReplyUseCase(authenticatedUser: UserSession, reply: { replyId: number }) {
...
export async function hasAccessToMutateReply(authenticatedUser: UserSession | undefined, replyId: number) {
...
export async function hasAccessToMutateReplyUseCase(authenticatedUser: UserSession | undefined, replyId: number) {
