...
export async function isGroupOwnerUseCase(authenticatedUser: UserSession | undefined, groupId: number) {
...
export async function isUserMemberOfGroupUseCase(authenticatedUser: UserSession | undefined, groupId: number) {
  if (!authenticatedUser) return false
...
export async function isGroupVisibleToUserUseCase(authenticatedUser: UserSession | undefined, groupId: number) {
